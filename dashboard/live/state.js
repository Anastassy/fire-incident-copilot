...
export const statusLabel = (s) => ({fresh:'Fresh',stale:'Stale',missing:'No data',disconnected:'Disconnected',invalid:'Error',paused:'Paused',playing:'Playing',completed:'Completed',queued:'Queued',running:'Checking',ready:'Answer ready',insufficient_data:'Insufficient data',error:'Error',cancelled:'Cancelled',checking:'Checking',supported:'Supporting report found',refuted:'Refuted',pending:'Publication pending',synced:'Published',uncertain:'Publication outcome unknown',active:'Active',closed:'Closed'}[s] || s || 'Unknown');
export const kindLabel = (s) => ({measurement:'Sensor',camera:'Camera',radio_audio:'Radio',radio_transcript:'Transcript',connectivity:'Connectivity',access:'Access',people_count:'People',transport:'Transport'}[s] || s);
